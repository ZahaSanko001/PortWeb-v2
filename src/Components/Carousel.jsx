...
const Carousel = () => {
    ...
    const startValue = isMobile ? 'top bottom' : "10% bottom";

    useGSAP(() => {
        const totalScroll = container1.current.scrollWidth - window.innerWidth;
        gsap.to(container1.current, {
            ...
            scrollTrigger: {
                ...
                start: startValue,
                end: () => `+=${totalScroll}` /* () => `+= ${container1.current.scrollWidth + 100 - window.innerWidth}` */,
                scrub: 1,
                markers: false,
            }, 
        });
    ...
    useGSAP(() => {
        const totalScroll = container4.current.scrollWidth - window.innerWidth;
        gsap.fromTo(container4.current,{x: -totalScroll}, {
            x: 0,
            ease: "none",
            scrollTrigger: {
                trigger: wrapper.current,
                start: startValue,
                end: "200% top"/* () => `+= ${container1.current.scrollWidth + 100 - window.innerWidth}` */,
                scrub: 1,
                markers: false,
            }, 
        });
    ...
    useGSAP(() => {
        const totalScroll = container2.current.scrollWidth - window.innerWidth;
        gsap.fromTo(container2.current,{x: -totalScroll}, {
            x: 0,
            ease: "none",
            scrollTrigger: {
                trigger: wrapper0.current,
                start: "10% bottom",
                end: "200% top"/* () => `+= ${container1.current.scrollWidth + 100 - window.innerWidth}` */,
                scrub: 1,
                markers: false,
    ...
    useGSAP(() => {
        const totalScroll = container3.current.scrollWidth - window.innerWidth;
        ...
        <div className="overflow-x-hidden h-screen flex flex-col justify-center gap-2" ref={wrapper0}>
            ...
            <div className="wrapper hidden md:flex" ref={wrapper}>
                <div className="flex space-x-6" ref={container1}>
                    ...
                    <div className="flex flex-col items-center">
                        <svg  className="w-15 h-15 md:w-20 md:h-20"xmlns="http://www.w3.org/2000/svg"  width="100"  height="100"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  ><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 6m-8 0a8 3 0 1 0 16 0a8 3 0 1 0 -16 0" /><path d="M4 6v6a8 3 0 0 0 16 0v-6" /><path d="M4 12v6a8 3 0 0 0 16 0v-6" /></svg>
                    DBMS
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        <svg  className="w-15 h-15 md:w-20 md:h-20"xmlns="http://www.w3.org/2000/svg"  width="100"  height="100"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  ><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 16v-6a2 2 0 1 1 4 0v6" /><path d="M8 13h4" /><path d="M16 8v8" /></svg>
                    Machine Learning
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        <svg className="w-20 h-20 rounded-4x0"xmlns="http://www.w3.org/2000/svg"  width="100"  height="100"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  ><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6.306 8.711c-2.602 .723 -4.306 1.926 -4.306 3.289c0 2.21 4.477 4 10 4c.773 0 1.526 -.035 2.248 -.102" /><path d="M17.692 15.289c2.603 -.722 4.308 -1.926 4.308 -3.289c0 -2.21 -4.477 -4 -10 -4c-.773 0 -1.526 .035 -2.25 .102" /><path d="M6.305 15.287c-.676 2.615 -.485 4.693 .695 5.373c1.913 1.105 5.703 -1.877 8.464 -6.66c.387 -.67 .733 -1.339 1.036 -2" /><path d="M17.694 8.716c.677 -2.616 .487 -4.696 -.694 -5.376c-1.913 -1.105 -5.703 1.877 -8.464 6.66c-.387 .67 -.733 1.34 -1.037 2" /><path d="M12 5.424c-1.925 -1.892 -3.82 -2.766 -5 -2.084c-1.913 1.104 -1.226 5.877 1.536 10.66c.386 .67 .793 1.304 1.212 1.896" /><path d="M12 18.574c1.926 1.893 3.821 2.768 5 2.086c1.913 -1.104 1.226 -5.877 -1.536 -10.66c-.375 -.65 -.78 -1.283 -1.212 -1.897" /><path d="M11.5 12.866a1 1 0 1 0 1 -1.732a1 1 0 0 0 -1 1.732z" /></svg>
                    React
                    </div>
            ...
            <div className="wrapper md:hidden" ref={wrapper}>
                <div className="flex space-x-6" ref={container4}>
