...
const About = () => {
    ...
    return (
       <>
       <div className="h-screen flex flex-row items-center justify-between relative">
            ...
            <div ref={contentRef} className="flex flex-col gap-2 md:gap-[6rem] items-center h-full">
                <h1 className="text-6xl md:text-8xl text-transparent bg-clip-text bg-gradient-to-r md:bg-gradient-to-t from-amber-500 via-amber-300 to-amber-200 md:from-white md:via-gray-300 md:to-gray-500">ABOUT ME</h1>
