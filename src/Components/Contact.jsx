...
const Contact = () => {
    return (
        <section id="contact">
            <div className="flex flex-col md:flex-row justify-around items-center h-[25rem] bg-gradient-to-t from-blue-300 via-gray-950 to-black border-t-2 border-blue-200/30 rounded-t-[4rem]">
                <div>
                ...
                <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <ul className="space-y-2">
                        ...
                        <li className="flex gap-2"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" /></svg>+880 162 478-2439</li>
                    </ul>
                </div>
            </div>
        </section> 
