...
const Contact = () => {
    return (
        <section id="contact">
            <div className="flex flex-col md:flex-row justify-around items-center h-[25rem] bg-gradient-to-t from-emerald-400 via-[#1A1A1A]/50 to-[#1A1A1A] border-t border-emerald-200/30 rounded-t-[4rem]">
                <div>
